...
export default function MoveCardPopover({ card }: MoveCardPopoverProps) {
    ...
    const moveCardMutation = useMutation({
        mutationFn: () => cardService.moveCard(card.id, selectedListId, position),
        onSuccess: () => {
                ...
                <>
                    ...
                    >
                        <Popover.Panel className="absolute left-0 z-10 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-200 p-4">
                            <h3 className="text-sm font-semibold text-gray-700 mb-3">Move Card</h3>
